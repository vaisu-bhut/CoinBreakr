          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                CoinBreakr collects minimal information necessary to provide our expense splitting services:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                CoinBreakr may integrate with analytics and notification services to improve app functionality.
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:privacy@coinbreakr.com" className="text-blue-600 hover:text-blue-800">
                  privacy@coinbreakrQ s.com
                </a>
              </p>
            </section>
          </div>
