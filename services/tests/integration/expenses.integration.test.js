...
//       testUser1._id,
//       [testUser1._id, testUser2._id, testUser3._id]
//     ));
...
//       expect(createResponse.body.data.splitWith).toHaveLength(3);
...
//         .get(`/v1/expenses/between/${testUser2._id}`)
//         .set('Authorization', `Bearer ${authToken1}`)
//         .expect(200);
...
//         .get(`/v1/expenses/between/${testUser3._id}`)
//         .set('Authorization', `Bearer ${authToken1}`)
//         .expect(200);
...
// //           amount: 100,
// //           splitWith: [{ user: testUser1._id, amount: 50 }, { user: testUser2._id, amount: 50 }, { user: testUser3._id, amount: 50 }],
// //           group: testGroup._id
// //         })
// //         .expect(403);
...
// //             amount: expense.amount,
// //             splitWith: [{ user: testUser2._id, amount: expense.amount / 2 }, { user: testUser1._id, amount: expense.amount / 2 }, { user: testUser3._id, amount: expense.amount / 2 }],
...
// //           amount: 50,
// //           splitWith: [{ user: testUser2._id, amount: 25 }, { user: testUser1._id, amount: 25 }, { user: testUser3._id, amount: 25 }]
// //         }),
